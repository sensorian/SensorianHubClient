 ...
 ****************************************************************************/
 ...
 /**
 * @file FXOS8700CQR1/Example1/FXOS8700CQ.h
 * @author D.Qendri
 * @date 30 May 2015
 * @brief Accelerometer / Magnetometer driver header.
 *
 */
 ...
 */
typedef enum mode_t {DISABLED=0x00,
						BUFFER=0x01,
						OVERFLOW=0x10,
						TRIGGERED=0x11} mode_t;
					
/**
 * Enumeration of the accelerometer accelerometer scale.
 */
typedef enum range_t {SCALE2G=0x00,
						SCALE4G=0x01,
						SCALE8G=0x10} range_t;


/**
 * Enumeration listing the sensor orientation modes
 */
typedef enum ACC_orientation_t{PORT_UP_FRONT = 0,
							PORT_UP_BACK,
							PORT_DOWN_FRONT,
							PORT_DOWN_BACK,
							LAND_LEFT_FRONT,
							LAND_LEFT_BACK,
							LAND_RIGHT_FRONT,
							LAND_RIGHT_BACK } ACC_orientation_t;

/**
 * @brief Structure encapsulating triple axis raw data.
 */
...
void 			FXOS8700CQ_WriteByteArray(unsigned char address,char reg, char* buffer, char value);
